...
{
    private const int PasueTargetsCapacity = 20;
    ...
    private readonly List<Action> _onPauseHandlerTargets = new(PasueTargetsCapacity);
    private readonly List<Action> _onPlayHandlerTargets = new(PasueTargetsCapacity);
